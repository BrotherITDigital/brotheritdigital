...
<div class="admin-card" style="max-width: 600px; margin: 0 auto;">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem; border-bottom:1px solid #E2E8F0; padding-bottom:1rem;">
        <h2 style="font-size: 1.125rem; font-weight: 700; color: #0F172A; margin: 0;">Edit Category</h2>
    ...
    <form action="{{ route('admin.portfolio-categories.update', $category->id) }}" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="name" id="name" class="form-control" style="width:100%; padding:.625rem; border:1px solid #CBD5E1; border-radius:.375rem; font-size:.875rem;" value="{{ old('name', $category->name) }}" required>
            @error('name')
        ...
        <div style="display:flex; justify-content:flex-end; gap:.75rem; border-top:1px solid #E2E8F0; padding-top:1.5rem; margin-top:2rem;">
            ...
            <button type="submit" class="btn btn-primary" style="padding: .5rem 1.25rem; font-size: .875rem;" id="update-btn">Update Category</button>
        </div>
    </form>
</div>
